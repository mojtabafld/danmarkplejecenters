...
const DA = {
  ...
  'panel.copy': 'Kopiér',
  'panel.copied': 'Kopieret',
  'panel.copyFailed': 'Kunne ikke kopiere',
  ...
  'note.save': 'Gem note',
  'note.delete': 'Slet note',
  'note.cancel': 'Annullér',
  'note.saved': 'Noten er gemt.',
  'note.deleted': 'Noten er slettet.',
...
const FA: Record<Key, Entry> = {
  ...
  'panel.copy': 'رونوشت',
  'panel.copied': 'رونوشت شد',
  'panel.copyFailed': 'رونوشت نشد',
