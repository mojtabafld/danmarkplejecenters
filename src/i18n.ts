...
const DA = {
  ...
  'note.label': 'Din note',
  'note.placeholder': 'Fx ventetid, hvem du talte med, hvad du så.',
  'note.save': 'Gem note',
...
const EN: Record<Key, Entry> = {
  ...
  'note.placeholder': 'Waiting time, who you spoke to, what you saw.',
  'note.save': 'Save note',
  'note.cancel': 'Cancel',
...
const FA: Record<Key, Entry> = {
  ...
  'note.placeholder': 'برای نمونه زمان انتظار، با چه کسی حرف زدید، چه دیدید.',
