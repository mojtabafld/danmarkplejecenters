...
const DA = {
  ...
  'account.why': 'Opret en konto for at markere plejecentre som besøgt og finde dem igen senere.',
...
const EN: Record<Key, Entry> = {
  ...
  'account.why': 'Create an account to mark care homes as visited and find them again later.',
...
const FA: Record<Key, Entry> = {
  ...
  'account.why': 'برای نشان کردن مراکز بازدیدشده و یافتن دوبارهٔ آن‌ها، حساب بسازید.',
