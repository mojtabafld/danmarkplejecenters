...
const PATHS: Record<string, string> = {
  ...
  // A page with a pen over it: writing something of your own about a place,
  // as against the pencil alone, which reads as editing what is already there.
  notePen:
  ...
  gauge:
    '<path d="M12 14a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z"/><path d="m13.4 10.6 3.6-3.6"/>' +
